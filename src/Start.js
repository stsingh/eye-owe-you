...
const Start = () => {
    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="p-3 mb-4 text-xl font-bold leading-none tracking-tight text-gray-900 md:text-2xl lg:text-3xl dark:text-white">Never lose sight of the money you borrow or lend again</div>
          <div>
            <div>
                <Link to={'/login'}>
